...
if (isset($_POST["button_save"])) {
    ...
    $checkRoomQuery = mysqli_query($con, "SELECT room_id FROM room WHERE room_id = '$room_id'");
    $roomExists = mysqli_num_rows($checkRoomQuery);
    ...
    if ($roomExists) {
        ...
        echo "Selected room does not exist";
    }
}
?>
